<?php
        ...
        if(isset($_POST["btn"])){
                ...
                $sql2="update std set name='$name',email='$email',admission_no=$admission where sid=$id";
...
<div class="container my-5 mx-6 shadow-lg p-3 mb-5 bg-white rounded">
  <form action="update.php?updateid=<?php echo $id; ?> " method="post">
        <div class="form-group row my-3">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control " id="n" name="name" value=<?php echo $row['name'];?> placeholder="enter your name" require="required"> 
            </div>
        </div>
            <div class="form-group row my-3">
            <label for="m" class="h4 col-sm-2 col-form-label">Email:</label>
            <div class="col-sm-10">
            <input type="email" class="form-control " id="m" name="email" value=<?php echo $row['email'];?> placeholder="enter your email" require="required"> 
            </div>
        </div>
        <div class="form-group row my-3" >
            <label for="a" class="h4 col-sm-2 col-form-label">Admission no:</label>
            <div class="col-sm-10">
            <input type="number" class="form-control" id="a" name="admission"  value=<?php echo $row['admission_no'];?>  placeholder="enter your admission" require="required"> 
            </div>
        </div>
